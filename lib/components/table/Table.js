...
var Table = function (_a) {
    ...
    var _o = useState({
        ...
        item: null,
    }), contextMenuProps = _o[0], setContextMenuProps = _o[1];
    ...
    var _p = useOnSort(), sort = _p.sort, addSort = _p.addSort;
    var _q = useOnFilter(), filters = _q.filters, addFilter = _q.addFilter, updateFilter = _q.updateFilter, clearFilter = _q.clearFilter, clearAllColumnFilters = _q.clearAllColumnFilters;
    var tableRef = useRef(null);
    var columnRefs = createColumnRefs(columns);
    var _r = usePagination({
        sort: sort,
        filters: filters,
        data: sortedData,
        limit: limit,
    ...
    }), pagination = _r.pagination, page = _r.page, totalPages = _r.totalPages, isLoading = _r.isLoading, pageData = _r.pageData, onChangePage = _r.onChangePage;
    var setResizeIndex = useOnResizeTable({
        table: tableRef,
        columns: columnRefs,
    }).setResizeIndex;
    var _s = useOnSelect(), selectedRows = _s.selectedRows, onSelect = _s.onSelect;
