...
var Table = function (_a) {
    var columns = _a.columns, columnKeyExtractor = _a.columnKeyExtractor, renderColumnItem = _a.renderColumnItem, data = _a.data, dataKeyExtractor = _a.dataKeyExtractor, renderData = _a.renderData, _b = _a.limit, limit = _b === void 0 ? 20 : _b, _c = _a.selectable, selectable = _c === void 0 ? false : _c, _d = _a.contextMenu, contextMenu = _d === void 0 ? false : _d, _e = _a.resizable, resizable = _e === void 0 ? true : _e, _f = _a.isServerSide, isServerSide = _f === void 0 ? false : _f, fetchDataOnPagination = _a.fetchDataOnPagination;
