...
var usePagination = function (_a) {
    var data = _a.data, page = _a.page, limit = _a.limit, sort = _a.sort, _b = _a.isServerSide, isServerSide = _b === void 0 ? false : _b, fetchDataOnPagination = _a.fetchDataOnPagination;
    var _c = useState(page || 1), currentPage = _c[0], setCurrentPage = _c[1];
    var _d = useState([]), pageData = _d[0], setPageData = _d[1];
    var handleOnServerSideChangePage = useCallback(function (page, limit, totalPages, sort) { return __awaiter(void 0, void 0, void 0, function () {
        var res;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, (fetchDataOnPagination === null || fetchDataOnPagination === void 0 ? void 0 : fetchDataOnPagination(page, limit, sort))];
                case 1:
                    res = _a.sent();
                    if (res.hasNextPage)
    ...
    useEffect(function () {
        if (isServerSide) {
            setPageData([]);
            setIsLoading(true);
            handleOnServerSideChangePage(currentPage, limit || 1, currentPage + 1, sort);
        }
        else {
            setPageData(limit
