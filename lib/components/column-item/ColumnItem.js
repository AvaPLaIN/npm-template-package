...
var ColumnItem = function (_a) {
    ...
    return (React.createElement("th", { ref: column.ref },
        ...
        React.createElement(ColumnMenu, { columnId: column.id, filters: filters, addFilter: addFilter, updateFilter: updateFilter, clearFilter: clearFilter, ref: columnMenuRef, isOpen: isColumnMenuOpen })));
};
